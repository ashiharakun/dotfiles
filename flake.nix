        ...
        flake =
          ...
          in
          {
            ...
            homeConfigurations = homes // {
              ...
              # NixOS ではない Linux (Linux Mint, hostname 4060ti) 向け。GUI アプリを含む。
              # `home-manager switch --flake .#4060ti`
              "4060ti" = home-manager.lib.homeManagerConfiguration {
